...
public class XxlJobServiceImpl implements XxlJobService {
    ...
    public ReturnT<String> add(XxlJobInfo jobInfo) {
        ...
        if (scheduleTypeEnum == ScheduleTypeEnum.FIX_RATE/* || scheduleTypeEnum == ScheduleTypeEnum.FIX_DELAY*/) {
            //具体的cron 正则校验
...
//            jobInfo.setChildJobId(temp);
            String temp = StrUtil.join(",", childJobIds);
            jobInfo.setChildJobId(temp);
        }
